...
void Web::init()
{
  ...
  {
    String r="";
    formlog(Application::getInstance(),r);
  ...
  server.on("/config",HTTP_GET, [&]()
  {
    String r="";
    String e="";
    formconfig(Application::getInstance(),lthermos, r,e);
    server.send(200, "text/html",r);
  });
  ...
  {
    String r=""; String e="";
    formdomo(Application::getInstance(),r,e);
    server.send(200, "text/html",r);
  });
...
void Web::handle_root()
{
  ...
  String str="";
  root(Application::getInstance(),lsensor,ldomo,str);
...
{
  String str="";
  sensor(Application::getInstance(),lsensor,str);
  server.send(200, "text/html", str);
  //delay(100);
}
