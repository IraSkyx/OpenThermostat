...
public:
	...
	uint8_t presmin = 8;
	uint8_t presmax = 20;
	Thermostat(String s, String fcal, SensorManager *se, IRManager *ir, DomoticzBroadcaster *domo);
	Thermostat(SensorManager *se, IRManager *ir, DomoticzBroadcaster *domo);
	void run();
	void off();
	void on();
	void save();
