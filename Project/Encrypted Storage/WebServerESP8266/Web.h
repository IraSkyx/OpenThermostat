...
public:
	...
	Web(SensorManager *lsensor, Thermostat * lthermos, WifiManager * lwifi, IRManager *ir, TimeNtp * ti, DomoticzBroadcaster *dom);
	void init();
	void root(SensorManager *sen, DomoticzBroadcaster *ldomo, String &str);
	String formconfig();
	void formconfig(Thermostat *t, String &str, String &error);
	void sensor(SensorManager *sen, String &str);
	void formplanning(Thermostat *t, String &str, String &error);
	void formlog(String &str);
	void formlogging(String &str, String &error);
	bool hasAccess(String &str);
	void formdomo(String &str, String &error);
};
